...
public class RegisterDoctorDtoResponse {
    ...
    public RegisterDoctorDtoResponse(int id, String firstName, String lastName, String patronymic, String speciality, String room, List<DayScheduleDtoResponse> schedule) {
        this.id = id;
